...
Our example models a simple com.ssc.bkb.payroll service that manages the employees of a company. Simply put, you need to store employee objects in an H2 in-memory database, and access them via JPA. This will be wrapped with a Spring MVC layer to access remotely.

.nonrest/src/main/java/com.ssc.bkb.payroll/Employee.java
[source,java,tabsize=2,indent=0]
----
include::nonrest/src/main/java/com.ssc.bkb.payroll/Employee.java[]
----
...
.nonrest/src/main/java/com.ssc.bkb.payroll/EmployeeRepository.java
[source,java,tabsize=2,indent=0]
----
include::nonrest/src/main/java/com.ssc.bkb.payroll/EmployeeRepository.java[]
----
...
.nonrest/src/main/java/com.ssc.bkb.payroll/PayrollApplication.java
[source,java,tabsize=2,indent=0]
----
include::nonrest/src/main/java/com.ssc.bkb.payroll/PayrollApplication.java[]
----
...
.nonrest/src/main/java/com.ssc.bkb.payroll/LoadDatabase.java
[source,java,tabsize=2,indent=0]
----
include::nonrest/src/main/java/com.ssc.bkb.payroll/LoadDatabase.java[]
----
...
----
...
2018-08-09 11:36:26.169  INFO 74611 --- [main] com.ssc.bkb.config.LoadDatabase : Preloading Employee(id=1, name=Bilbo Baggins, role=burglar)
2018-08-09 11:36:26.174  INFO 74611 --- [main] com.ssc.bkb.config.LoadDatabase : Preloading Employee(id=2, name=Frodo Baggins, role=thief)
...
----
...
.nonrest/src/main/java/com.ssc.bkb.payroll/EmployeeController.java
[source,java,tabsize=2,indent=0]
----
include::nonrest/src/main/java/com.ssc.bkb.payroll/EmployeeController.java[]
----
...
.nonrest/src/main/java/com.ssc.bkb.payroll/EmployeeNotFoundException.java
[source,java,tabsize=2]
----
include::nonrest/src/main/java/com.ssc.bkb.payroll/EmployeeNotFoundException.java[]
----

When an `EmployeeNotFoundException` is thrown, this extra tidbit of Spring MVC configuration is used to render an *HTTP 404*:

.nonrest/src/main/java/com.ssc.bkb.payroll/EmployeeNotFoundAdvice.java
[source,java,tabsize=2,indent=0]
----
include::nonrest/src/main/java/com.ssc.bkb.payroll/EmployeeNotFoundAdvice.java[]
----
...
[source,java,tabsize=2,indent=0]
----
include::rest/src/main/java/com.ssc.bkb.payroll/EmployeeController.java[tag=get-single-item]
----
...
[source,java,tabsize=2,indent=0]
----
include::rest/src/main/java/com.ssc.bkb.payroll/EmployeeController.java[tag=get-aggregate-root]
----
...
.evolution/src/main/java/com.ssc.bkb.payroll/EmployeeModelAssembler.java
[source,java,tabsize=2,indent=0]
----
include::evolution/src/main/java/com.ssc.bkb.payroll/EmployeeModelAssembler.java[]
----
...
[source,java,tabsize=2,indent=0]
----
include::evolution/src/main/java/com.ssc.bkb.payroll/EmployeeController.java[tag=constructor]
...
[source,java,tabsize=2,indent=0]
----
include::evolution/src/main/java/com.ssc.bkb.payroll/EmployeeController.java[tag=get-single-item]
----
...
[source,java,tabsize=2,indent=0]
----
include::evolution/src/main/java/com.ssc.bkb.payroll/EmployeeController.java[tag=get-aggregate-root]
----
...
[source,java,tabsize=2,indent=0]
----
include::evolution/src/main/java/com.ssc.bkb.payroll/Employee.java[]
----
...
[source,java,tabsize=2,indent=0]
----
include::evolution/src/main/java/com.ssc.bkb.payroll/LoadDatabase.java[tag=new_constructor]
----
====
...
[source,java,tabsize=2,indent=0]
----
include::evolution/src/main/java/com.ssc.bkb.payroll/EmployeeController.java[tag=post]
----
...
[source,java,tabsize=2,indent=0]
----
include::evolution/src/main/java/com.ssc.bkb.payroll/EmployeeController.java[tag=put]
----
...
[source,java,tabsize=2,indent=0]
----
include::evolution/src/main/java/com.ssc.bkb.payroll/EmployeeController.java[tag=delete]
----
...
.links/src/main/java/com.ssc.bkb.payroll/Order.java
[source,java,tabsize=2,indent=0]
----
include::links/src/main/java/com.ssc.bkb.payroll/Order.java[]
----
...
.links/src/main/java/com.ssc.bkb.payroll/Status.java
[source,java,tabsize=2,indent=0]
----
include::links/src/main/java/com.ssc.bkb.payroll/Status.java[]
----
...
.links/src/main/java/com.ssc.bkb.payroll/OrderController.java
[source,java,tabsize=2]
----
include::links/src/main/java/com.ssc.bkb.payroll/OrderController.java[tag=main]
}
----
...
.links/src/main/java/com.ssc.bkb.payroll/OrderModelAssembler.java
[source,java,tabsize=2,indent=0]
----
include::links/src/main/java/com.ssc.bkb.payroll/OrderModelAssembler.java[]
----
...
[source,java,tabsize=2,indent=0]
----
include::links/src/main/java/com.ssc.bkb.payroll/OrderController.java[tag=delete]
----
...
[source,java,tabsize=2,indent=0]
----
include::links/src/main/java/com.ssc.bkb.payroll/OrderController.java[tag=complete]
----
...
[source,java,tabsize=2,indent=0]
----
include::links/src/main/java/com.ssc.bkb.payroll/LoadDatabase.java[]
----
